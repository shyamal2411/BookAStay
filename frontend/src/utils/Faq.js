                        ...
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                                ...
                                <p className="text-body-color text-lg">
                                    ...
                                    cannot find the answer you are looking for, please contact us.
                                </p>
                            </div>
                        </div>
                    </div>
...
const AccordionItem = ({ header, text }) => {
    ...
    return (
        <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] lg:px-6 xl:px-8 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)]">
            ...
            <div className={`pl-[62px] duration-200 ease-in-out ${active ? "block" : "hidden"}`}>
                <p className="text-body-color rounded-md bg-slate-100 p-3 text-base leading-relaxed">
                    {text}
                </p>
            </div>
        </div>
